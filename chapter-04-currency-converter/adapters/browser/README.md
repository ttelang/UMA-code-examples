...
```bash
# From the chapter-04-currency-converter directory
cd /workspaces/UMA-code-examples/chapter-04-currency-converter
...
cd chapter-04-currency-converter/adapters/browser
